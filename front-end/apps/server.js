...
const AUTHORIZATION_ENDPOINT =
  process.env.AUTHORIZATION_ENDPOINT ||
    "http://kong-dev.ingress.local/iam/realms/smap-platform/protocol/openid-connect/auth";
  
const TOKEN_ENDPOINT =
  process.env.TOKEN_ENDPOINT ||
      "http://kong-dev.ingress.local/iam/realms/smap-platform/protocol/openid-connect/token";
